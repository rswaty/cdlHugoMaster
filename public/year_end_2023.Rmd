...
```
* Robyn Holmes delivered a presentation titled "Searching for Goldilocks: Exploring remotely sensed data products in the context of beaver and wildfire" at a LANDFIRE [Open Office Hour](https://www.youtube.com/watch?v=7ztYoqoooMU&ab_channel=LANDFIREvideo). Spoiler alert(s): mid-resolution data (10m pixel size) seemed to work best, and beaver dams do appear to influence wildfire behavior (supporting work by Fairfax and Whittle, 2020, and others).
...
* Silas  Pickhardt, Liv Maynard, Nick Burns and Trinity Hinshaw were recruited by the Marquette County (MI) Planning Commission to build dashboard presenting current ecosystem, wildfire exposure risk and late-succession habitat for the central Upper Peninsula of Michigan. 

* Eleanor Gagnon will be building a web report depicting ecological fire management needs for Missouri in support of The Nature Conservancy an other land management partners there. 

* Emily Mydlowski is collaborating with Melanie Rudolf of The Nature Conservancy's Arkansas chapter to update their fire management monitoring data collection forms, wrangle formerly collected data and to develop a GitHub hosted web reporting platform.
